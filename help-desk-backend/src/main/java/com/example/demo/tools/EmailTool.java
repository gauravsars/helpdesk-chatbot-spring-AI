...
//send the email to support team regarding new ticket.
    ...
    public void sendEmailToSupportTeam(@ToolParam(description = "Email id associated with ticket for contact information")String email, @ToolParam(description = "short summary of the ticket")String message) {
